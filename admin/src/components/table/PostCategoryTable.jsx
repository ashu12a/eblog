            ...
            {blogs?.data?.map((post, index) => (
              ...
              >
                <td className="px-6 py-1 text-gray-800">
                  {" "}
                  {(blogs.pagination.page - 1) * blogs.pagination.limit +
                    index +
                    1}{" "}
                </td>
                <td className="px-6 py-1 text-gray-800">
                ...
                <td className="px-6 py-1 text-gray-800 flex flex-wrap gap-x-1 gap-y-2">
                  {post.subCategories.map((item) => (
                    <span key={item} className="text-xs px-2 py-1 bg-gray-200 mx-1 rounded whitespace-nowrap">
                      {item.slice(0, 75)}
                      {item.length > 75 && "..."}
                    </span>
                  ))}
                </td>
                <td className="px-6 py-1 text-gray-500">
                ...
                <td className="px-6 py-1 text-center">
                  <button
                    ...
                    className="px-2 py-1 text-yellow-500 rounded hover:bg-neutral-200"
                  >
                    <BiSolidPencil />
                  </button>
                  <button
                    className="px-2 py-1 text-red-600 rounded hover:bg-neutral-200"
